...
public class ArithmeticSimpleOperation extends AbstractOperation {
	...
	public String execute(OperationData data) {
		...
		try {
			...
			LOG.debug("arithmetic operation {} with operand1: {} and operand2: {}", data.additionalData,
					arithmeticData.operand1, arithmeticData.operand2);
			...
			res = wrongDtoMessage;
			LOG.error("Arithemtic operation but received data for class {} ", data.getClass().getSimpleName());
		}
		return res;
	}
