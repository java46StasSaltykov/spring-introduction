...
public class DatesSimpleOperation extends AbstractOperation {
	...
	public String execute(OperationData data) {
		...
		try {
			...
			LOG.debug("computing date {} days {} from {}", data.additionalData, dateData.days, dateData.date);
			...
			res = wrongDtoMessage;
			LOG.error("Date after/before finding but received data for class {} ", data.getClass().getSimpleName());
		}
